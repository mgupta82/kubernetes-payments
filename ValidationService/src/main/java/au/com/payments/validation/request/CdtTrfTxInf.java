...
public class CdtTrfTxInf {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(cdtrAcct).append(rmtInf).append(pmtId).append(cdtrAgt).append(dbtr).append(instdAmt).append(intrBkSttlmAmt).append(intrBkSttlmDt).append(purp).append(dbtrAcct).append(chrgBr).append(cdtr).append(dbtrAgt).toHashCode();
    }
