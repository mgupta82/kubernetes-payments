...
public class CdOrPrtry implements Serializable
{
    ...
    private final static long serialVersionUID = 565169624405223152L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CdOrPrtry) == false) {
            return false;
        }
        CdOrPrtry rhs = ((CdOrPrtry) other);
