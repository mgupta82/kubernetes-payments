 ...
 * generated in the com.example.jaxb.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:pacs.002.001.09", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.jaxb.schema
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.09", name = "Document")
